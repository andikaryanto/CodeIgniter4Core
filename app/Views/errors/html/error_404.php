...
<html>
  ...
  <!-- CSS Files -->
  <link href="<?= base_url('assets/material-dashboard/assets/css/material-dashboard.min.css');?>" rel="stylesheet" />
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="#pablo"><?php echo lang('Form.notfound')?></a>
      </div>
      ...
      <div class="content-center">
        <div class="row">
          <div class="col-md-12">
            ...
            <h2><?php echo lang('Info.youre_lost')?></h2>
            <h4><?php echo lang('Info.page_not_found')?></h4>
          </div>
        </div>
      </div>
      <footer class="footer">
