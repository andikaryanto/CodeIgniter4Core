                                        ...
                                        <div class="tab-pane active" id="about">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <label class="bmd-label-floating"><?= lang('Form.completename')?></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group bmd-form-group">
                                                    <label class="bmd-label-floating"><?= lang('Form.email')?></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group bmd-form-group">
                                                    <label class="bmd-label-floating"><?= lang('Form.telephone')?></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group bmd-form-group">
                                                    <label class="bmd-label-floating"><?= lang('Form.address')?></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group bmd-form-group">
                                                    <label class="bmd-label-floating"><?= lang('Form.aboutme')?></label>
                ...
                <div class="col-md-4">
                    <div class="card card-profile">
                        <div class="card-avatar">
                            <a href="#pablo">
                                <img class="img" src="<?= base_url($_SESSION[getSessionVariable_config()['userprofile']]['PhotoPath'].$_SESSION[getSessionVariable_config()['userprofile']]['PhotoName'])?>">
                            </a>
                            </div>
                            <div class="card-body">
                            <h6 class="card-category text-gray"><?= $_SESSION[getSessionVariable_config()['userdata']]['Username']?></h6>
