                ...
                <div class="card-header card-header-primary">
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <p class="card-category"> <?= lang('Form.master_province')?></p>
                    </div>
                    
                    <div class="col">
                      <div class="text-right">
                        <button type="button" rel="tooltip" class="btn btn-primary btn-round btn-fab" title="<?= lang('Form.add')?>" onclick="window.location.href='<?= base_url('mprovince/add');?>'">
